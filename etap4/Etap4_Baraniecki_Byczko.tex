...
\begin{figure}[H]
	...
	\resizebox*{0.9\textwidth}{!}{
		\includegraphics{../etap3/TS_Network_Logic.drawio.png}
	}
\end{figure}
\cleardoublepage
...
\subsection{Router Cisco ISR4221/K9}
\begin{figure}[H]
	\centering
	\resizebox*{\textwidth}{!}{
		\includegraphics{pictures/Router-card-ISR4221-K9.png}
	}
\end{figure}
...
\begin{figure}[H]
   \centering
   \resizebox*{\textwidth}{!}{
	  \includegraphics{pictures/ws-cs2960.png}
   }
\end{figure}
...
\begin{figure}[H]
	\centering
	\resizebox*{\textwidth}{!}{
		\includegraphics{pictures/sf350.png}
	}
\end{figure}
...
\begin{figure}[H]
	\centering
	\resizebox*{\textwidth}{!}{
		\includegraphics{pictures/sf220.png}
	}
\end{figure}
...
\begin{figure}[H]
	\centering
	\resizebox*{\textwidth}{!}{
		\includegraphics{pictures/tp-link-eap265hd.png}
	}
\end{figure}
